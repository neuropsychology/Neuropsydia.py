...
# Change neuropsydia.screen to "__main__" When building API documentation. This is to avoid sphinx to run this code, otherwise the documentations fails to be built.

if __name__ == "neuropsydia.__main__":
